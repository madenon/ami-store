        ...
        <div className="flex-1">
          ...
          <div className="flex items-center gap-3 my-3">
            <button
              ...
              className=" text-black hover:bg-red-500 -z-1 font-medium border border-red-400 px-8 py-3 rounded-se-lg text-sm bg-white "
            >
              ACHETR MAINTENANT
            </button>
            <button
              onClick={() => addToCart(productData._id, size)}
              className=" text-black hover:bg-red-500 font-medium border border-red-400 px-8 py-3 rounded-se-lg text-sm bg-white"
            >
              AJOUTER AU PANIER
            </button>
          </div>
