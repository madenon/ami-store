...
const ProductItem = ({id, image, productName, price}) => {
 ...
 <img  onClick={()=>window.scrollTo({top:0, behavior:"smooth"})} className='hover:scale-110 transition  ease-out w-full border border-r-2 border-slate-300  shadow-lg br-radis  bg-slate-700  gap-5  max-h-48' src={image[0]} alt="" />
    </div>
